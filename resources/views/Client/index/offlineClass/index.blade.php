<fieldset class="container-fluid">
    ...
    <section id="select-class-offline">
        <div onclick="itemHandle(1,this)" class="grade-offline">
            <i class="fas fa-user-graduate ml-2"></i>
            پایه تحصیلی و عنوان درس
        </div>
        <div onclick="itemHandle(2,this)" class="question-count">
            <i class="fas fa-hourglass-start ml-2"></i>
            تعداد سوال و هزینه آن
        </div>
        <div onclick="itemHandle(3,this)" class="date-get-answer">
            <i class="fas fa-calendar-alt ml-2"></i>
            زمان دریافت پاسخ

        </div>
        <div onclick="itemHandle(4,this)" class="get-record-offline">
